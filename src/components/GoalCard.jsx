...
export default function GoalCard({ goal, onAddProgress, onPause, onResume, onComplete, onPress }) {
  ...
  return (
    <TouchableOpacity accessibilityRole="button" onPress={() => onPress?.(goal)} style={[styles.card, { backgroundColor: theme.colors.card, borderColor: theme.colors.border }]}>
      ...
      <View style={styles.row}>
        <Text style={{ color: theme.colors.text, fontWeight: "600" }}>{pct}%</Text>
